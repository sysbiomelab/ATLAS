...
var = 'host_phenotype'
#PRJDB4176 = crcmeta.loc[crcmeta.study_accession == 'PRJDB4176']
#PRJEB6070 = meta.loc[meta.study_accession == crcmeta]
#X = msp.T.loc[PRJDB4176.set_index('secondary_sample_accession').index]
