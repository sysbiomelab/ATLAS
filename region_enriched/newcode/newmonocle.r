...
if (trajectoryMode) {
  ...
  basicMetaMapUpdated = read.csv('../../data/basicMetadata.Theo.SL.2022.08.18.csv')
...
#theo
        ...
        trajectoryTaxaTab = data.frame(gene_short_name = rownames(vect_atlas), 
                                       biotype="protein_coding",
                                       num_cells_expressed = 1,
                                       use_for_ordering=FALSE)
        ...
        pd <- new("AnnotatedDataFrame", data = vect_atlas)
        ...
        cds <- newCellDataSet(as.matrix(vect_atlas), 
                              phenoData = pd, 
                              featureData = fd,
                              lowerDetectionLimit = 0.1)
